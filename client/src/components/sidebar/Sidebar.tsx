...
function Sidebar() {
  ...
  return (
    <aside className="flex w-full md:h-full md:w-auto">
      <div
        className={cn(
          "fixed bottom-0 left-0 z-50 flex h-[50px] w-full gap-4 border-t border-darkHover bg-dark p-2 md:static md:h-full md:w-[50px] md:flex-col md:border-r md:border-t-0 md:pt-4",
      ...
      >
        ...
        <div className="flex justify-center">
          <button
            className="rounded p-1.5 hover:bg-[#3D404A]"
            onClick={changeState}
      ...
      <div
        className="absolute left-0 top-0 z-20 w-full bg-dark md:static md:min-w-[300px]"
